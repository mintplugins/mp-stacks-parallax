 ...
 if (!function_exists('mp_stacks_parallax_update')){
	function mp_stacks_parallax_update() {
		$args = array(
			...
			'software_api_url' => 'http://mintplugins.com',//The URL where Parallax and mp_stacks-parallax are installed and checked
...
add_action( 'admin_init', 'mp_stacks_parallax_update' );
